...
### **Tibble template for features vector**  

```{r}
features <- tibble(raw_mean_ax = 0, raw_mean_ay = 0, raw_mean_az = 0,
                   fft_mean_ax = 0, fft_mean_ay = 0, fft_mean_az = 0,
                   raw_median_ax = 0, raw_median_ay = 0, raw_median_az = 0,
                   fft_median_ax = 0, fft_median_ay = 0, fft_median_az = 0)
```
...
2.2 Add user id label-column  
2.3 Select data for walking activity only (#4)  
3. Calculate features for particular user  
