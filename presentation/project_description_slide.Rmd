---
title: "Activity Recognition from Single Chest-Mounted Accelerometer Data Set"
...
![](img/sliding_windows.png)
  
  
* Both time and frequency domain features are extracted.  
The Fast Fourier Transform (FFT) of the axial data of the identification windows for each of the axes is evaluated, which forms the base for all frequency domain features
...
$Centroid = \sum_ { k = 1 }^l (x_tk f_tk) / { l }$  
where:  
