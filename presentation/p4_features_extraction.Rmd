...
# 1. Setup sliding window parameters
...
# 2. Setup parameters for peak detection
...
# 3. Function for features extracting for single user
...
# **Veery time-consuming operation OPERATION!!!**
